  ...
  return (
    <section id="about" className="min-h-screen flex items-center justify-center py-20 px-4">
      <div className="max-w-4xl mx-auto">
        <motion.h2
          className="text-4xl md:text-5xl font-bold text-center mb-12 text-neutral-900 dark:text-white"
        ...
        >
          ...
          <div className="p-6 rounded-lg bg-neutral-100 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700">
            <h3 className="text-2xl font-bold mb-2 text-pink-500 dark:text-pink-400">
              {t("about.technologies.count")}
            </h3>
            <p className="text-neutral-600 dark:text-neutral-400">
              {t("about.technologies.label")}
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {t("about.specialties.list").split(",").map((specialty, index) => (
              <motion.span
                key={index}
